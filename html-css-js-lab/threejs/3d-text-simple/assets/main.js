THREE.Cache.enabled = true;
    ...
    for ( var ii in weightMap ) reverseWeightMap[ weightMap[ ii ] ] = ii;
            ...
            for ( var i = 0; i < textGeo.faces.length; i ++ ) {
                ...
                if ( face.materialIndex === 1 ) {
                    ...
                    if ( s > triangleAreaHeuristics ) {
                        ...
                        for ( var u = 0; u < face.vertexNormals.length; u ++ ) {

                            face.vertexNormals[ u ].copy( face.normal );
